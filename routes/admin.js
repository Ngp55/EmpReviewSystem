...
router.get('/add-employee', passport.checkAuthentication, adminController.addtoshowEmployee);
router.post('/add-dbemployee', passport.checkAuthentication, adminController.addEmployee);
